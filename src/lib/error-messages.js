const messages = {
  de: {
    ...
    REQUIRED_EVIDENCE_MISSING: "Bitte reiche Vorderseite, Rückseite und das Live-Video vollständig ein.",
  ...
  en: {
    ...
    REQUIRED_EVIDENCE_MISSING: "Please provide the ID front, ID back and live video in full.",
