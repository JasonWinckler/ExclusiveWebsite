const messages = {
  de: {
    ...
    user_more_factors_required: "Bitte bestätige die Anmeldung mit deinem zweiten Sicherheitsfaktor.",
    user_invalid_code: "Der Sicherheitscode ist ungültig oder abgelaufen. Bitte prüfe den aktuellen Code und versuche es erneut.",
    user_auth_method_unsupported: "Diese Sicherheitsmethode ist im Moment nicht verfügbar.",
    INVALID_EMAIL_OR_PASSWORD: "E-Mail-Adresse oder Passwort ist nicht korrekt.",
    PASSWORD_MIGRATION_REQUIRED: "Dein Konto wurde sicher zu Cloudflare übertragen. Lege über „Passwort vergessen“ einmalig ein neues Passwort fest; deine Inhalte und Membership bleiben erhalten.",
    LOGIN_TEMPORARILY_LOCKED: "Zu viele fehlgeschlagene Anmeldeversuche. Bitte warte 15 Minuten oder setze dein Passwort zurück.",
    PASSWORD_POLICY_NOT_MET: "Verwende mindestens 6 Zeichen, darunter mindestens einen Buchstaben oder eine Zahl und ein Sonderzeichen.",
    EMAIL_ALREADY_REGISTERED: "Für diese E-Mail-Adresse besteht bereits ein Konto.",
    CURRENT_PASSWORD_INCORRECT: "Das aktuelle Passwort ist nicht korrekt.",
    AUTH_TOKEN_INVALID_OR_EXPIRED: "Dieser sichere Link ist abgelaufen oder wurde bereits verwendet. Bitte fordere einen neuen an.",
    INVALID_MFA_CODE: "Der Sicherheitscode ist ungültig. Bitte prüfe den aktuellen Code oder einen unbenutzten Recovery-Code.",
    AUTHENTICATION_REQUIRED: "Bitte melde dich an, um diese Aktion auszuführen.",
    ACCOUNT_RESTRICTED: "Dieses Konto ist derzeit gesperrt. Bitte wende dich an den Support.",
    ACCOUNT_DELETION_PENDING: "Dieses Konto wurde zur Löschung vorgemerkt oder bereits gelöscht.",
    ...
    PASSWORD_RESET_PERSISTENCE_FAILED: "Das neue Passwort konnte gerade nicht gespeichert werden. Bitte versuche es erneut.",
    ...
    AGE_REVIEW_WINDOW_EXPIRED: "Die 48-stündige Prüffrist ist abgelaufen. Deine Nachweise wurden gelöscht; bitte starte eine neue Altersprüfung.",
    EVIDENCE_MEDIA_SIGNATURE_MISMATCH: "Der tatsächliche Dateityp stimmt nicht mit dem angegebenen Format überein. Bitte nimm die Datei neu auf.",
    ...
    DEVICE_CREDENTIAL_REVOKED: "Dieses Gerät ist gesperrt. Entsperre es über ein anderes angemeldetes Gerät oder wende dich an den Support.",
    DEVICE_LOCKED: "Dieses Gerät ist gesperrt. Entsperre es über ein anderes angemeldetes Gerät oder wende dich an den Support.",
    DEVICE_NOT_FOUND: "Dieses Gerät wurde nicht gefunden oder bereits entfernt.",
    ADMIN_SESSION_REQUIRED: "Bitte öffne den Admin-Bereich erneut, um eine sichere 10-Minuten-Sitzung zu starten.",
    ADMIN_SESSION_EXPIRED: "Die sichere Admin-Sitzung ist nach 10 Minuten abgelaufen. Bitte melde dich erneut an.",
    ADMIN_MFA_REQUIRED: "Richte zuerst die verpflichtende Zwei-Faktor-Authentifizierung für dein Admin-Konto ein.",
    INVALID_ADMIN_SIMULATION_ROLE: "Diese Simulationsrolle ist nicht verfügbar.",
    ADMIN_SIMULATION_READ_ONLY: "Die Admin-Simulation ist schreibgeschützt. Beende sie, um Änderungen vorzunehmen.",
    ADMIN_SIMULATION_ROUTE_UNAVAILABLE: "Diese kontospezifische Funktion ist in der Rollen-Simulation nicht verfügbar.",
    ACTIVE_PREMIUM_OR_VIP_REQUIRED: "Der private Telegram-Kanal ist für eine aktive Premium- oder VIP-Membership verfügbar.",
    PREMIUM_TELEGRAM_NOT_CONFIGURED: "Der Telegram-Zugang ist momentan nicht verfügbar. Bitte versuche es später erneut.",
    TELEGRAM_ACCESS_ADMIN_SUSPENDED: "Der Telegram-Zugang wurde administrativ pausiert. Bitte wende dich an den Support.",
    TELEGRAM_MEMBERSHIP_EXPIRING: "Die verbleibende Membership-Laufzeit ist zu kurz für einen neuen Einladungslink.",
    TELEGRAM_API_UNAVAILABLE: "Telegram ist momentan nicht erreichbar. Bitte versuche es gleich erneut.",
    TELEGRAM_API_REQUEST_FAILED: "Telegram konnte die sichere Aktion momentan nicht abschließen. Bitte versuche es erneut.",
    TELEGRAM_INVITE_CREATION_FAILED: "Der persönliche Telegram-Zugang konnte gerade nicht erstellt werden.",
    TELEGRAM_MEMBER_REMOVAL_FAILED: "Der Telegram-Zugang konnte gerade nicht entfernt werden. Die Aktion wird erneut geprüft.",
    TELEGRAM_CONNECTION_NOT_FOUND: "Für dieses Konto besteht keine Telegram-Verknüpfung.",
    CONTENT_MEDIA_SIGNATURE_MISMATCH: "Der tatsächliche Dateityp stimmt nicht mit dem angegebenen Medienformat überein.",
  ...
  en: {
    ...
    user_more_factors_required: "Confirm this sign-in with your second security factor.",
    user_invalid_code: "The security code is invalid or expired. Check the current code and try again.",
    user_auth_method_unsupported: "This security method is currently unavailable.",
    INVALID_EMAIL_OR_PASSWORD: "The email address or password is incorrect.",
    PASSWORD_MIGRATION_REQUIRED: "Your account was securely moved to Cloudflare. Use “Forgot password” once to set a new password; your content and membership remain intact.",
    LOGIN_TEMPORARILY_LOCKED: "Too many failed sign-in attempts. Wait 15 minutes or reset your password.",
    PASSWORD_POLICY_NOT_MET: "Use at least 6 characters, including at least one letter or number and one special character.",
    EMAIL_ALREADY_REGISTERED: "An account already exists for this email address.",
    CURRENT_PASSWORD_INCORRECT: "The current password is incorrect.",
    AUTH_TOKEN_INVALID_OR_EXPIRED: "This secure link has expired or has already been used. Please request a new one.",
    INVALID_MFA_CODE: "The security code is invalid. Check the current code or use an unused recovery code.",
    AUTHENTICATION_REQUIRED: "Please sign in to perform this action.",
    ACCOUNT_RESTRICTED: "This account is currently restricted. Please contact support.",
    ACCOUNT_DELETION_PENDING: "This account is pending deletion or has already been deleted.",
    ...
    PASSWORD_RESET_PERSISTENCE_FAILED: "The new password could not be saved right now. Please try again.",
    ...
    AGE_REVIEW_WINDOW_EXPIRED: "The 48-hour review window has expired. Your evidence was deleted; please start a new age verification.",
    EVIDENCE_MEDIA_SIGNATURE_MISMATCH: "The actual file type does not match the declared format. Please capture the file again.",
    ...
    DEVICE_CREDENTIAL_REVOKED: "This device is locked. Unlock it from another signed-in device or contact support.",
    DEVICE_LOCKED: "This device is locked. Unlock it from another signed-in device or contact support.",
    DEVICE_NOT_FOUND: "This device was not found or has already been removed.",
    ADMIN_SESSION_REQUIRED: "Reopen the admin area to start a secure 10-minute session.",
    ADMIN_SESSION_EXPIRED: "The secure admin session expired after 10 minutes. Please sign in again.",
    ADMIN_MFA_REQUIRED: "Set up the required two-factor authentication for your administrator account first.",
    INVALID_ADMIN_SIMULATION_ROLE: "This simulation role is unavailable.",
    ADMIN_SIMULATION_READ_ONLY: "The admin simulation is read-only. Exit it before making changes.",
    ADMIN_SIMULATION_ROUTE_UNAVAILABLE: "This account-specific function is unavailable in role simulation.",
    ACTIVE_PREMIUM_OR_VIP_REQUIRED: "The private Telegram channel is available with an active Premium or VIP membership.",
    PREMIUM_TELEGRAM_NOT_CONFIGURED: "Telegram access is currently unavailable. Please try again later.",
    TELEGRAM_ACCESS_ADMIN_SUSPENDED: "Telegram access has been administratively paused. Please contact support.",
    TELEGRAM_MEMBERSHIP_EXPIRING: "Too little membership time remains to create a new invitation link.",
    TELEGRAM_API_UNAVAILABLE: "Telegram is currently unavailable. Please try again shortly.",
    TELEGRAM_API_REQUEST_FAILED: "Telegram could not complete the secure action right now. Please try again.",
    TELEGRAM_INVITE_CREATION_FAILED: "Your personal Telegram access could not be created right now.",
    TELEGRAM_MEMBER_REMOVAL_FAILED: "Telegram access could not be removed right now. The action will be checked again.",
    TELEGRAM_CONNECTION_NOT_FOUND: "No Telegram connection exists for this account.",
    CONTENT_MEDIA_SIGNATURE_MISMATCH: "The actual file type does not match the declared media format.",
