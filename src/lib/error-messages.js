const messages = {
  de: {
    ...
    INVALID_DISPLAY_NAME: "Bitte wähle einen Benutzernamen mit 2 bis 64 Zeichen und mindestens einem Buchstaben oder einer Zahl.",
    USERNAME_CHANGE_COOLDOWN: "Der Benutzername kann erst nach Ablauf der 14-tägigen Sperrfrist erneut geändert werden.",
  ...
  en: {
    ...
    INVALID_DISPLAY_NAME: "Choose a username with 2 to 64 characters and at least one letter or number.",
    USERNAME_CHANGE_COOLDOWN: "The username can only be changed again after the 14-day waiting period.",
